...
<div class="global-body scrollable">
    ...
    <form id="form" class="form-horizontal" method="post" action="javascirpt:;">
        ...
        <div class="page-body">
            ...
            <div class="form-group">
                <div class="col-sm-1 control-label">
                    <?php echo form::label(t('创始人账号'),'admin_username')?>
                </div>
                <div class="col-sm-10">
                    <?php echo form::field(array(
                        'type'=>'text',
            ...
            <div class="form-group">
                <div class="col-sm-1 control-label">
                    <?php echo form::label(t('创始人密码'),'admin_password')?>
                </div>
                <div class="col-sm-10">
                    <?php echo form::field(array(
                        'type'=>'text',
            ...
            <div class="form-group">
                <div class="col-sm-1 control-label">
                    <?php echo form::label(t('创始人邮箱'),'admin_email')?>
                </div>
                <div class="col-sm-10">
                    <?php echo form::field(array(
                        'type'=>'text',
        ...
        <div class="page-body">
            ...
            <div class="form-group mysql-ui">                   
                        <div class="col-sm-1 control-label"><?php echo form::label(t('Mysql主机'),'mysql_hostname')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'text',
                                'id'=>'mysql_hostname',
            ...
            <div class="form-group mysql-ui">
                        <div class="col-sm-1 control-label"><?php echo form::label(t('Mysql端口'),'mysql_hostport')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'number',
                                'id'=>'mysql_hostport',
            ...
            <div class="form-group mysql-ui">       
                        <div class="col-sm-1 control-label"><?php echo form::label(t('Mysql用户名'),'mysql_username')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'text',
                                'id'=>'mysql_username',
            ...
            <div class="form-group mysql-ui">       
                        <div class="col-sm-1 control-label"><?php echo form::label(t('Mysql密码'),'mysql_password')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'text',
                                'id'=>'mysql_password',
            ...
            <div class="form-group mysql-ui">       
                        <div class="col-sm-1 control-label"><?php echo form::label(t('数据库名称'),'mysql_database')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'text',
                                'id'=>'mysql_database',
            ...
            <div class="form-group sqlite-ui" id="sqlite" style="display:none;">
                        ...
                        <div class="col-sm-1 control-label"><?php echo form::label(t('数据库名称'),'sqlite_database')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'text',
                                'id'=>'sqlite_database',
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-1 control-label"><?php echo form::label(t('数据表前缀'),'prefix')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'text',
                                'id'=>'prefix',
            ...
            <div class="form-group">
                        ...
                        <div class="col-sm-1 control-label"><?php echo form::label(t('持久连接'),'mysql_pconnect')?></div>
                        <div class="col-sm-10">
                            <?php echo form::field(array(
                                'type'=>'bool',
                                'id'=>'pconnect',
