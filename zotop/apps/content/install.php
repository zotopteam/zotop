...
$this->db->createTable('content',array(
	'fields'=>array(
		...
		'parentid'	=> array ( 'type'=>'int', 'length'=>10, 'default'=>'0', 'notnull'=>true, 'unsigned'=>true, 'comment' => t('父编号') ),
...
$this->db->createTable('content_category',array(
	'fields'=>array(
		...
		'alias'		=> array ( 'type'=>'varchar', 'length'=>50, 'default'=>null, 'comment' => t('别名') ),
		'title'		=> array ( 'type'=>'varchar', 'length'=>100, 'default'=>null, 'comment' => t('标题') ),
		'banner'	=> array ( 'type'=>'varchar', 'length'=>100, 'default'=>null, 'comment' => t('横幅') ),
