...
<div class="main side-main">
	...
	<div class="main-body scrollable">
		...
		<table class="field">
			<tbody>
			<tr>
				<td class="label">{form::label(t('区块类型'),'type',true)}</td>
				<td class="input">
					{form::field(array('type'=>'radio','options'=>$types,'name'=>'type','value'=>$data['type']))}
				</td>
			</tr>
			<tr>
...
<script type="text/javascript">
	...
	function forminit(type){
		...
		$('.extend').html('<i class="icon icon-loading"></i>');
		$('.extend').load("{U('block/admin/postextend')}", data, function(){
