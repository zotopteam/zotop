...
<div class="main side-main">
	<div class="main-header">
		...
		<div class="position">
			<a href="{u('system/theme/index')}"><i class="fa fa-skin"></i> {t('主题管理')}</a>
			<s class="arrow">></s>
			<a href="{u('system/theme/template?theme='.$theme)}"><i class="fa fa-template"></i> {t('模版管理')}</a>
			{loop $position $p}
			<s class="arrow">></s> <a href="{u('system/theme/template?theme='.$theme.'&dir='.$p[1])}"><i class="fa fa-folder"></i> {$p[0]}</a>
			{/loop}
		</div>
		<div class="action">
			<div class="btn-group" role="group">
				<a class="btn btn-primary js-open"  data-width="600px" data-height="300px" href="{u('system/theme/template_newfolder?theme='.$theme.'&dir='.$dir)}">
					<i class="fa fa-folder fa-fw"></i> <b>{t('新建目录')}</b>
				</a>
				<a class="btn btn-primary js-open"  data-width="600px" data-height="300px" href="{u('system/theme/template_newfile?theme='.$theme.'&dir='.$dir)}">
	...
	<div class="main-body scrollable">
		...
		{loop $folders $f}
			<tr>
				<td class="text-center va-m"><b class="fa fa-folder fa-2x text-primary"></b></td>
				<td>
				...
				<td class="manage text-right">
					<a class="js-open" href="{u('system/theme/template_renamefolder?theme='.$theme.'&dir='.$f['path'])}" data-width="600px" data-height="300px">
						<i class="fa fa-edit fa-fw"></i> {t('重命名')} & {t('注释')}
					</a>
					<s>|</s>
		...
		{loop $files $f}
			<tr>
				<td class="text-center va-m"><b class="fa fa-file fa-2x text-primary"></b></td>
				<td>
