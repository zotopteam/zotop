...
return array(
	...
	'register_validmail_title'		=> t('{sitename}: 请验证您的邮箱'),
	'register_validmail_content'	=> t('<h2>欢迎您注册成为{site}用户</h2><p>请点击下面链接进行认证：</p><p>{click}</p> <p>或者将网址复制到浏览器：</p><p>{url}</p>'),
	...
	// 找回密码设置，默认有效期单位小时
	'getpasswordmail_title'		=> '{sitename}：密码找回',
