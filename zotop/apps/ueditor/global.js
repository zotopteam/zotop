...
$.fn.editor = function(options){
	...
	var settings = {
		...
		//initialStyle : 'html{hight:100%;}body{padding:5px;}p{margin:8px 0px;}img,embed,object{max-width:100%;}',
		iframeCssUrl : options.css,
		wordCount : false,
	...
	switch(options.theme){
		...
		default:
			settings.toolbars = [
				['undo', 'redo','pasteplain','autotypeset','removeformat', 'formatmatch','paragraph', 'fontfamily', 'fontsize','insertcode','bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'blockquote', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist',
				'indent','lineheight', 'justifyleft', 'justifycenter', 'justifyright','justifyjustify','link', 'unlink', 'anchor','date', 'time','insertimage', 'emotion','insertvideo','music','map','highlightcode','horizontal','spechars','insertframe','inserttable','searchreplace','source','fullscreen']
			];
			break;
	}
