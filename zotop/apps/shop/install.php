...
// [shop_goods] 创建
$this->db->table('shop_goods')->drop();
$this->db->table('shop_goods')->create(array(
	'fields'=>array(
...
$this->db->table('shop_goods_attr')->create(array(
	'fields'=>array(
...
// [shop_category] 创建
$this->db->table('shop_category')->drop();
$this->db->table('shop_category')->create(array(
	'fields'=>array(
...
// [shop_type] 创建
$this->db->table('shop_type')->drop();
$this->db->table('shop_type')->create(array(
	'fields'=>array(
		'id'		=> array ( 'type'=>'int', 'length'=>10, 'notnull'=>true, 'unsigned'=>true, 'autoinc'=>true, 'comment' => t('编号') ),
...
// [shop_attr] 创建
/*
$this->db->table('shop_attr')->drop();
$this->db->table('shop_attr')->create(array(
	'fields'=>array(
...
// [shop_spec] 创建
$this->db->table('shop_spec')->drop();
$this->db->table('shop_spec')->create(array(
	'fields'=>array(
		'id'		=> array ( 'type'=>'int', 'length'=>10, 'notnull'=>true, 'unsigned'=>true, 'autoinc'=>true, 'comment' => t('编号') ),
...
// [shop_brand] 创建
$this->db->table('shop_brand')->drop();
$this->db->table('shop_brand')->create(array(
	'fields'=>array(
